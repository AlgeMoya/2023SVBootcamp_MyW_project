          ...
          >
            ...
            <Page number={1} chapter={1}>
              <div className="flex flex-col items-center">
                ...
                <img src={(novelStory != null) ? novelStory[0]?.image : "null"} className="flex flex-col items-center object-cover" style={{width: '344px', height: '300px'}} />
              </div>
            </Page>
            ...
            <Page number={3} chapter={2}>
              <div className="flex flex-col items-center">
                ...
                <img src={(novelStory != null) ? novelStory[1]?.image : "null"} className="flex flex-col items-center object-cover" style={{width: '344px', height: '300px'}} />
              </div>
            </Page>
